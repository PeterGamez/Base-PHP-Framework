...
trait JoinClause
{
    ...
    {
        if ($tablealias) {
            $this->jointable[] = " JOIN $table AS $tablealias ON $tablealias.$column1 = " . $this->maintable . ".$column2";
        } else {
            $this->jointable[] = " JOIN $table ON $table.$column1 = " . $this->maintable . ".$column2";
        }
        return $this;
    }
    ...
    {
        if ($tablealias) {
            $this->jointable[] = " LEFT JOIN $table AS $tablealias ON $tablealias.$column1 = " . $this->maintable . ".$column2";
        } else {
    ...
    {
        if ($tablealias) {
            $this->jointable[] = " RIGHT JOIN $table AS $tablealias ON $tablealias.$column1 = " . $this->maintable . ".$column2";
        } else {
